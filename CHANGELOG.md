...
- **Penyempurnaan Halaman Monitoring & Daftar (Desa, OPD, Pimpinan & Kepala Desa)**:
    ...
    - Menghapus kelas `overflow-hidden` pada pembungkus kartu utama (`bg-white rounded-lg`) di halaman Website Desa dan Website OPD untuk membiarkan menu pilihan dropdown Choices.js melayang di atas konten secara alami (*overflow visible*) tanpa terpotong (*clipped*).
