...
- **Penghapusan Fitur Sinkronisasi NIK & Email Terdaftar BSrE**:
  - Menghapus kolom `tte_source` dan `email_bsre` dari tabel `emails` melalui migrasi [`DropTteSourceAndEmailBsreFromEmails.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Database/Migrations/2026-09-09-214140_DropTteSourceAndEmailBsreFromEmails.php) serta menghapusnya dari [`EmailModel.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Models/EmailModel.php).
  - Menghapus rute `POST bsre/check-nik` pada [`Routes.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Config/Routes.php) dan method `checkNikStatus()` pada [`BsreController.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Controllers/BsreController.php).
  - Mengembalikan alur sinkronisasi status TTE pada [`BsreController.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Controllers/BsreController.php), [`TteSyncService.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Shared/Services/TteSyncService.php), dan CLI [`SyncTteUnit.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Commands/SyncTteUnit.php) murni berbasis alamat email resmi dinas `@sinjaikab.go.id`.
  - Menghapus field input manual pada [`edit_profile.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/edit_profile.php) dan penanganannya pada [`EmailController.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Controllers/EmailController.php).
  - Membersihkan elemen antarmuka pada [`detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/detail.php) dan [`unit_kerja_detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/unit_kerja_detail.php) dari badge penanda tambahan dan fungsi pengecekan NIK.
...
- **Format Notifikasi Telegram Ringkas & Kontekstual**:
  ...
  - Menghilangkan penayangan status normal pada notifikasi ringkasan (seperti "Semua Normal" atau "Semua Aktif") saat tidak ada akun/domain bermasalah agar pesan tetap ringkas, serta memperbarui judul seksi domain menjadi "Domain Expired <30 Hari" dengan pelabelan hari yang akurat (`Expired` atau `Sisa X hari`).
...
- **Penyelarasan Kolom & Dokumen PDF**:
  ...
  - Mengatur kondisi penayangan jabatan & unit Plt pada tabel dan PDF unit kerja definitif ([`unit_kerja_detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/unit_kerja_detail.php), [`unit_kerja_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/unit_kerja_pdf.php), [`account_detail_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/account_detail_pdf.php)): ditampilkan jika penugasan Plt berada di **unit kerja/OPD yang sama**, dan disembunyikan jika penugasan Plt berada di **OPD eksternal berbeda**.
  - Memperbarui tampilan kolom Unit Kerja & Jabatan ketika akun Plt dilihat dari unit penugasannya ([`unit_kerja_detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/unit_kerja_detail.php), [`unit_kerja_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/unit_kerja_pdf.php), [`account_detail_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/account_detail_pdf.php)): teks jabatan Plt utama diberi warna amber (`text-amber-700`) dan hanya menampilkan hierarki sub-unit penugasan Plt-nya (bukan unit definitif luar).
  - Menerapkan **pengurutan hierarki struktural pejabat dan sub-unit** pada tabel dan PDF unit kerja ([`EmailService.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Services/EmailService.php), [`EmailExportService.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Services/EmailExportService.php)): memprioritaskan pejabat struktural bereselon (Eselon II $\rightarrow$ III $\rightarrow$ IV) di posisi teratas, mengurutkan kelompok **Asisten Sekda** sebelum **Staf Ahli Bupati**, disusul para **Kepala Bagian** dan staf pelaksana per sub-unit.
...
- **Logika Sinkronisasi Pegawai PNS & Resolusi Sub Unit Plt**:
  - Menambahkan pengisian otomatis kolom NIK dari respon API SIMPEG (`data_pegawai`) jika NIK di database lokal masih kosong pada [`EmailService.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Domains/Email/Services/EmailService.php).
  - Menambahkan *skeleton loading pulse* pada field NIK serta memperbarui interaktivitas DOM pada halaman Detail Akun ([`detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/detail.php), [`sync-helper.js`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/public/js/sync-helper.js)).
  - Merapikan struktur *skeleton pulse* pada tabel unit kerja ([`unit_kerja_detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/unit_kerja_detail.php), [`sync-helper.js`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/public/js/sync-helper.js)) agar secara adaptif menampilkan pulse ganda (slate & amber) untuk jabatan ber-Plt dan pulse tunggal untuk jabatan non-Plt, serta mempertahankan kestabilan label status ASN.
...
- **Antarmuka Riwayat Laporan**:
  - Merapikan tombol "Lihat PDF" dengan standar `btn btn-outline`, ikon PDF merah, serta memastikan teks selalu 1 baris (`whitespace-nowrap flex-nowrap`).
  - Mengatur proporsi lebar kolom tabel secara seimbang dan menambahkan utilitas `break-all` pada kolom nama file di [`history.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/history.php).
  - Menghapus skrip lama pemicu *auto-download* otomatis via *hidden iframe*.
- **Aset & Antarmuka**:
  - Membangun dan mengompilasi berkas CSS Tailwind (`npm run build`).
...
- **Manajemen & Penanganan Jabatan Plt**:
  ...
  - Menstandarisasi penulisan nama jabatan Plt pimpinan secara ringkas tanpa pengulangan nama instansi/OPD (contoh: `PLT. KEPALA DINAS`, `PLT. SEKRETARIS DINAS`, `PLT. KEPALA BADAN`, `PLT. CAMAT`, `PLT. LURAH`, `PLT. DIREKTUR`).
- **Integrasi Antarmuka & Dokumen Export**:
  - Menampilkan seksi terpadu `Pelaksana Tugas` pada kartu profil Kepegawaian di halaman Detail Akun ([`detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/detail.php)).
  - Menampilkan jabatan dan unit kerja Plt pada Tabel Halaman Pimpinan ([`pimpinan.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/pimpinan.php)) dan Dokumen Export PDF ([`pimpinan_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/pimpinan_pdf.php)) dengan tipografi yang serasi.
  - Menampilkan pegawai Plt pada tabel Web Detail Unit Kerja ([`unit_kerja_detail.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/unit_kerja_detail.php)) dan Dokumen Export PDF ([`unit_kerja_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/unit_kerja_pdf.php) & [`account_detail_pdf.php`](file:///Users/abedzul/Desktop/htdocs/sinjai-emails/app/Views/email/exports/account_detail_pdf.php)) di unit kerja Plt tujuan maupun penugasan Plt internal di unit asal.
- **Aset & Antarmuka**:
