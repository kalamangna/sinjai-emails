...
- **Command Rekonsiliasi NIP SIMPEG (`sync:match-nip`)**:
  ...
  - Menambahkan fitur **Pencarian Lintas Unit Kerja (`--cross-unit`)** untuk mendeteksi pegawai yang telah mengalami mutasi/pindah OPD, sekaligus memperbarui NIP dan menyelaraskan `unit_kerja_id` ke OPD barunya di SIMPEG secara otomatis.
