...
class EmailService
{
    ...
    public function normalizeJabatanName(?string $jabatan, ?string $unitKerjaName = null, bool $isPimpinan = false): ?string
    {
        ...
        $jab = preg_replace('/\bPELAYANAAN\b/i', 'PELAYANAN', $jab);
        ...
        if (preg_match('/^(PENGADMINISTRASI|PENGELOLA|PENGOLAH|OPERATOR|PRANATA|BENDAHARA|PENGEMUDI|PRAMU|PETUGAS|STAF|TEKNISI|FASILITATOR|PENYUSUN|PEMERIKSA|ANALIS|GURU|DOKTER|PERAWAT|BIDAN|APOTEKER|EPIDEMIOLOG|SANITARIAN|NUTRISIONIS|ARSIPARIS|PUSTAKAWAN|AUDITOR|PERENCANA|PENYULUH|INSTRUKTUR|STATISTISI|PENELITI|PENGUJI|POLISI PAMONG PRAJA|MEDIK VETERINER|PARAMEDIK VETERINER|PENGAWAS BIBIT|PENGAWAS MUTU)\b/i', $jab)) {
            $jab = preg_replace('/\s+(?:(?:PADA|DI)\s+)?(?:SEKSI|SUB\s*BAGIAN|SUB\s*BIDANG|BIDANG|BAGIAN)\s+.*$/i', '', $jab);
