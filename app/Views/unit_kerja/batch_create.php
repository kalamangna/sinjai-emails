...
<div class="max-w-2xl mx-auto space-y-6">
    <div>
        <h1 class="text-2xl font-semibold text-gray-800">Buat Unit Kerja Massal</h1>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
        <div class="p-8">
            <form action="<?= site_url('unit_kerja/batch_store') ?>" method="post" class="space-y-6">
                ...
                <div>
                    <label for="parent_id" class="block text-sm font-medium text-gray-700 mb-1">Unit Induk <span class="text-gray-700 font-normal">(Opsional)</span></label>
                    <select name="parent_id" id="parent_id" class="choices-search block w-full px-3 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:border-emerald-700 text-sm font-medium text-gray-800 appearance-none cursor-pointer">
                ...
                <div>
                    ...
                    <textarea class="block w-full px-3 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:border-emerald-700 text-sm font-medium text-gray-800 min-h-[300px] font-mono uppercase placeholder-gray-200 custom-scrollbar" id="unit_kerja_names" name="unit_kerja_names" placeholder="CONTOH:&#10;DINAS KESEHATAN&#10;DINAS PENDIDIKAN" required></textarea>
                </div>
