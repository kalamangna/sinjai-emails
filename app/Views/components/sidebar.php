<aside id="sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform bg-slate-800 border-r border-slate-700 flex flex-col lg:translate-x-0 -translate-x-full">
    ...
    <nav class="flex-grow py-6 px-4 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <!-- Pegawai Submenu -->
        <div>
            <button data-sidebar-toggle="pegawai" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
        ...
        <!-- Pejabat Submenu -->
        <div>
            <button data-sidebar-toggle="pejabat" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
                <div class="flex items-center">
                    <div class="w-5 h-5 flex items-center justify-center mr-3 shrink-0">
        ...
        <!-- Organisasi Submenu -->
        <div>
            <button data-sidebar-toggle="organisasi" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
                <div class="flex items-center">
                    <div class="w-5 h-5 flex items-center justify-center mr-3 shrink-0">
        ...
        <!-- Website Submenu -->
        <div>
            <button data-sidebar-toggle="website" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
                <div class="flex items-center">
                    <div class="w-5 h-5 flex items-center justify-center mr-3 shrink-0">
        ...
        <?php if (in_array(session()->get('role'), ['super_admin', 'admin'])): ?>
            <div>
                <button data-sidebar-toggle="batch" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
                    <div class="flex items-center">
                        <div class="w-5 h-5 flex items-center justify-center mr-3 shrink-0">
        ...
        <?php if (session()->get('role') === 'super_admin'): ?>
            <div>
                <button data-sidebar-toggle="master" aria-expanded="false" class="w-full flex items-center justify-between px-4 py-2 text-sm font-medium text-slate-100 rounded-lg hover:bg-slate-700/80 hover:text-white transition-all focus:outline-none">
                    <div class="flex items-center">
                        <div class="w-5 h-5 flex items-center justify-center mr-3 shrink-0">
