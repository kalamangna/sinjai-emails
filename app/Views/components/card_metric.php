...
$colorClasses = [
    ...
    'blue'    => ['bg' => 'bg-blue-50',    'icon' => 'bg-blue-600',    'text' => 'text-blue-600',    'border' => 'border-blue-200',    'ring' => 'group-hover:ring-blue-600'],
...
<div class="group bg-white border border-slate-200 rounded-2xl p-6 transition-all hover:shadow-lg hover:shadow-slate-200/50 hover:border-slate-200">
    <div class="flex items-center justify-between mb-4">
        <div class="w-10 h-10 <?= $theme['bg'] ?> border <?= $theme['border'] ?> rounded-xl flex items-center justify-center transition-colors group-hover:bg-slate-800 group-hover:border-slate-800 shadow-sm">
