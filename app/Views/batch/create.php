...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <h1 class="text-2xl font-bold text-slate-800 uppercase tracking-tight">Buat Akun Massal</h1>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex justify-end pt-4 border-t border-slate-100">
                <button id="generate_btn" class="btn btn-solid">
    ...
    <div class="flex justify-end">
        <button id="submit_btn" class="btn btn-solid btn-lg" disabled>
...
<script>
    ...
    window.BATCH_CHECK_URL = '<?= site_url('user/batch_check_availability') ?>';
