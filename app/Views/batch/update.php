...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <h1 class="text-2xl font-bold text-slate-800 uppercase tracking-tight">Edit Akun Massal</h1>
        ...
        <div class="p-6">
            <form id="batch_update_form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-6">
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="update_mode" id="mode_nik" value="nik" checked class="w-4 h-4 text-slate-700 border-slate-200 focus:ring-slate-700">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="flex justify-between items-end mb-1">
                                ...
                                <button type="button" class="btn btn-outline btn-xs" onclick="document.getElementById('name_input').value = document.getElementById('name_input').value.toUpperCase()">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select id="eselon_input" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 focus:border-slate-700 text-sm appearance-none cursor-pointer transition-all">
                                <option value="">Tidak Ada Perubahan</option>
                        ...
                        <div>
                            ...
                            <select id="pimpinan_input" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 focus:border-slate-700 text-sm appearance-none cursor-pointer transition-all">
                                <option value="">Tidak Ada Perubahan</option>
                        ...
                        <div>
                            ...
                            <select id="pimpinan_desa_input" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 focus:border-slate-700 text-sm appearance-none cursor-pointer transition-all">
                                <option value="">Tidak Ada Perubahan</option>
                ...
                <div class="flex justify-end pt-4 border-t border-slate-100">
                    <button type="submit" id="update_btn" class="btn btn-solid btn-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('batch_update_form').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?= site_url('batch/process-update') ?>', {
                    method: 'POST',
                    headers: {
