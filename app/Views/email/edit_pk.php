        ...
        <form action="<?= site_url('email/update_pk/' . $email['user']) ?>" method="post">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_kontrak_awal" id="tanggal_kontrak_awal" value="<?= esc($pk_data['tanggal_kontrak_awal'] ?? '') ?>" class="block w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 focus:border-slate-700 text-sm font-medium text-slate-800 transition-all" required>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="gaji_nominal" id="gaji_nominal" value="<?= number_format($pk_data['gaji_nominal'] ?? 0, 0, ',', '.') ?>" class="block w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-700 focus:border-slate-700 text-sm font-bold text-slate-800 transition-all" required>
                            </div>
                        </div>
                        <div class="md:col-span-2">
            ...
            <div class="bg-slate-50 px-8 py-4 flex flex-col sm:flex-row justify-end gap-3 border-t border-slate-200">
                ...
                <button type="submit" class="order-1 sm:order-2 btn btn-solid">
                    <i class="fas fa-save mr-2 text-white/80"></i> Update PK
                </button>
            </div>
        </form>
    </div>
