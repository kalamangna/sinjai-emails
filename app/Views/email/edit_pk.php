    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
        <form action="<?= site_url('email/update_pk/' . $email['user']) ?>" method="post">
            ...
            <div class="p-8 space-y-10">
                ...
                <!-- Bagian: Penghasilan -->
                <div class="space-y-6">
                    <h4 class="text-[10px] font-bold text-slate-700 uppercase tracking-widest border-b border-slate-100 pb-1">Gaji</h4>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="gaji_nominal" class="block text-sm font-medium text-slate-700 mb-1 uppercase tracking-tight">Gaji Nominal (Rp)</label>
                            <div class="relative">
