...
<div class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-slate-100 bg-slate-50">
            <form id="pnsFilterForm" method="GET" action="" class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-4 items-end">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="<?= site_url('email/pns') ?>" class="btn btn-outline text-xs px-3" title="Reset">
