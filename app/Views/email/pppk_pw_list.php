...
<div class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="p-4 sm:p-6 border-b border-slate-100 bg-slate-50">
            <form id="pppkPwFilterForm" method="GET" action="" class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-4 items-end">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="<?= site_url('email/pppk-pw') ?>" class="btn btn-outline text-xs px-3" title="Reset">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col" id="pegawai-container-<?= $email['id'] ?>" data-nip="<?= esc($email['nip']) ?>">
                                        ...
                                        <div class="flex items-center gap-1.5 flex-wrap mt-0.5">
                                            <span class="text-[10px] font-bold text-slate-500 font-mono">NIP: <?= esc($email['nip'] ?: '-') ?></span>
                                            <?php
