...
<div class="flex justify-center py-12">
    <div class="w-full max-w-2xl">
        <div class="bg-white border border-slate-200 rounded-lg shadow-sm overflow-hidden relative group">
            ...
            <div class="p-12 text-center relative z-10">
                <div class="inline-flex items-center justify-center w-24 h-24 bg-white border border-slate-200 border-l-4 border-l-slate-700 rounded-2xl mb-10 text-red-600 shadow-sm">
                ...
                <?php if (!empty($back_url)): ?>
                    <div class="pt-10 border-t border-slate-100">
                        <a href="javascript:void(0);" onclick="history.back();" class="inline-flex items-center px-10 py-4 bg-slate-700 hover:bg-slate-800 text-white rounded-lg font-bold text-xs uppercase tracking-widest transition-all shadow-sm no-underline">
