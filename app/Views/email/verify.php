...
<head>
    ...
    <meta name="description" content="<?= $meta_description ?? ('Verifikasi Identitas Digital ' . ($email['name'] ?? '')) ?>">
    ...
    <meta property="og:description" content="<?= $meta_description ?? ('Verifikasi Identitas Digital ' . ($email['name'] ?? '')) ?>">
    ...
    <meta name="twitter:description" content="<?= $meta_description ?? ('Verifikasi Identitas Digital ' . ($email['name'] ?? '')) ?>">
