...
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold text-gray-800 uppercase tracking-tight">Edit Password</h1>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden flex flex-col">
        <form action="<?= site_url('email/update_password/' . $email['user']) ?>" method="post">
            ...
            <div class="p-8 space-y-6">
                <div class="flex items-center gap-4 p-4 rounded-lg bg-gray-50 border border-gray-100">
                    <div class="w-12 h-12 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-700 shrink-0">
                        <i class="fas fa-user-shield text-xl"></i>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-gray-700 uppercase tracking-widest">Email</p>
                        <p class="text-sm font-bold text-gray-800"><?= esc($email['email']) ?></p>
                    </div>
                </div>

                <div class="p-4 rounded-lg bg-white border border-gray-200 border-l-4 border-l-emerald-700 text-[11px] font-medium text-amber-500 leading-relaxed">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-1 uppercase tracking-tight">Password Baru</label>
                    <div class="relative">
                        ...
                        <input type="text" name="password" id="password" required minlength="8"
                            class="block w-full pl-9 pr-3 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-700 focus:border-emerald-700 text-sm font-semibold text-gray-800 font-mono tracking-wider transition-all"
