...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="<?= site_url('email/export_pimpinan_pdf') ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg font-bold text-xs uppercase tracking-widest hover:bg-gray-50 transition-all shadow-sm no-underline">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Pimpinan</h1>
            </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
        <form action="<?= current_url() ?>" method="get" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
            ...
            <div class="md:col-span-2 flex gap-2">
                ...
                <a href="<?= site_url('email/pimpinan') ?>" class="inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-lg transition-all shadow-sm" title="Reset">
...
<script>
    function syncAllBsreStatus() {
        ...
        if (!containers.length || !confirm('Sinkronkan status sertifikat untuk pimpinan yang tampil?')) return;
