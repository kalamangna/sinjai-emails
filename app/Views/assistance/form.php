            ...
            <form action="<?= isset($activity) ? site_url('assistance/update/' . $activity['id']) : site_url('assistance/store') ?>" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-6 h-[38px]">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" class="w-4 h-4 text-gray-900 border-gray-300 focus:ring-gray-400" name="method" value="Online"
                                    <?= (isset($activity) && $activity['method'] == 'Online') ? 'checked' : '' ?> required>
                                <span class="ml-2 text-sm text-gray-700">Online</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" class="w-4 h-4 text-gray-900 border-gray-300 focus:ring-gray-400" name="method" value="Offline"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 text-sm font-medium text-gray-900 appearance-none cursor-pointer" id="category" name="category" onchange="updateServicesDropdown()" required>
                    ...
                    <div>
                        ...
                        <select class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 text-sm font-medium text-gray-900 appearance-none cursor-pointer" id="service" name="service" onchange="updateKeteranganOptions()" required>
                ...
                <div>
                    ...
                    <select class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 text-sm font-medium text-gray-900 appearance-none cursor-pointer" id="keterangan" name="keterangan" required>
                        <option value="">Pilih Keterangan...</option>
                    </select>
                </div>

                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-100">
                    <a href="<?= site_url('assistance') ?>" class="w-full sm:w-auto px-6 py-2 bg-white border border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-50 transition-all text-xs uppercase tracking-widest no-underline flex items-center justify-center shadow-sm">
